...
from .models import Post, Profile, Like_Post, Followers_count
...
def profile(request,pk):
    ...
    user_followers = len(Followers_count.objects.filter(user=pk))
    user_following = len(Followers_count.objects.filter(follower=pk))
    context = {
